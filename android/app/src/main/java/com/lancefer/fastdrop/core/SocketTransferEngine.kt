...
import com.lancefer.fastdrop.model.TransferState
...
/**
 * Moteur de transfert binaire TCP conforme au protocole FDSP v1
 */
object SocketTransferEngine {
    ...
    /**
     * Transmettre un flux binaire (fichiers SAF / InputStream) vers le socket du destinataire
     */
    suspend fun sendStream(
        ...
        try {
            // Envoi de l'en-tête FDSP v1
            val header = "FDSP\u0001".toByteArray(Charsets.UTF_8)
